...
public class EntertainmentFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (REQUESTHTTP_OK == msg.what) {
					LogUtil.i("nongweiyi", "=========EntertainmentFragment_OK===========");
					...
					if (newsList != null) {
						...
						Toast.makeText(getActivity(), "娱乐==当前数据为空", 0).show();
					}
		...
		// 2.调用方法从网络上获取数据
		FragmentUtil.getNewsFromHttp(EntertainmentFragment.this.getActivity(), handler, httpUrl, httpArg,
				REQUESTHTTP_OK);
		return view;
	}
