...
public class SportFragment extends Fragment {
	...
	Handler handler;
	String httpUrl = "http://api.huceo.com/tiyu/other/";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if(Headline_REQUESTHTTP_OK==msg.what){
					LogUtil.i("nongweiyi", "=========SportFragment===========");
					...
					if(newsList!=null){
						...
						Toast.makeText(getActivity(), "体育==当前数据为空", 0).show();
					}
			}
			}
		...
		// 2.调用方法从网络上获取数据
		FragmentUtil.getNewsFromHttp(SportFragment.this.getActivity(),handler, httpUrl, httpArg,Headline_REQUESTHTTP_OK);
		return view;
	}	
