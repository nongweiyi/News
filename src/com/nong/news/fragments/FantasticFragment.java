 ...
 * 
 */
public class FantasticFragment extends Fragment {
	/****************************************** 画廊相关 ******************************************************/
	...
	private String apiKey = "75fe3d32fd12df7611b52cbebe0ffa5c";

	private View view;// 碎片的布局
	Handler handler;
	String httpUrl = "http://api.huceo.com/qiwen/other/";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (Headline_REQUESTHTTP_OK == msg.what) {
					LogUtil.i("nongweiyi", "=========FantasticFragment_OK===========");
					...
					if (newsList != null) {
						...
						Toast.makeText(getActivity(), "奇闻==当前数据为空", 0).show();
					}
				}
			}
		...
		// 2.调用方法从网络上获取数据
		FragmentUtil.getNewsFromHttp(FantasticFragment.this.getActivity(), handler, httpUrl, httpArg,
	...
	private void setDataToListView() {
		BaseAdapter adapter = new CustomListViewAdapter(getActivity(), newsList);
