...
public class InternationalFragment extends Fragment {
	...
	Handler handler;
	String httpUrl = "http://api.huceo.com/world/other/";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if(Headline_REQUESTHTTP_OK==msg.what){
					LogUtil.i("nongweiyi", "=========InternationalFragment_OK===========");
					...
					if(newsList!=null){
						...
						Toast.makeText(getActivity(), "国外==当前数据为空", 0).show();
					}
				}
			}
		...
		// 2.调用方法从网络上获取数据
		FragmentUtil.getNewsFromHttp(InternationalFragment.this.getActivity(),handler, httpUrl, httpArg,Headline_REQUESTHTTP_OK);
		return view;
	}	
