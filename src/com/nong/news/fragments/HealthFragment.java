...
public class HealthFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (Headline_REQUESTHTTP_OK == msg.what) {
					LogUtil.i("nongweiyi", "=========HealthFragment_OK===========");
					...
					if (newsList != null) {
						...
						Toast.makeText(getActivity(), "健康==当前数据为空", 0).show();
					}
				}
			}
		...
		// 2.调用方法从网络上获取数据
		FragmentUtil.getNewsFromHttp(HealthFragment.this.getActivity(), handler, httpUrl, httpArg,
